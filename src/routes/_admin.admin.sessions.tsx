...
import type { SessionStatus } from "@/lib/api-client";
...
const statusFilters: ("all" | SessionStatus)[] = [
  "all",
  "pending",
  "in-review",
  "approved",
  ...
  return (
    <>
      <AdminPageHeader
        ...
        subtitle={`${data?.total ?? 0} sessions match your filters.`}
      />
